...
public class VoucherController {
	...
	public boolean CheckExist (VoucherCard vr, Vector<VoucherCard> vrs) {
	...
	public boolean AddVoucherCard (VoucherCard vr){
	...
	public boolean DeleteVoucherCard (VoucherCard vr) {
